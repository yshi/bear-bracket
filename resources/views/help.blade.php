        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 prose dark:prose-invert mx-auto">
                    <h2>What is this?</h2>
                    <p>This is a Fat Bear Week bracket site, hosting both the Junior pre-tournament for the cubs, and
                        the main event.</p>
                    ...
                    <p>It's a group of people who probably know each other. It's more fun to compete against your
                        friends to see who can pick the fattest bears.</p>
                    ...
                    <p>Yes, check out <a href="https://github.com/yshi/bear-brackets" target="_blank"><code>yshi/bear-brackets</code></a>
                        on github.</p>
